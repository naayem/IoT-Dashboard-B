...
namespace IoTDashboard.Tests
{
    public class DeviceServiceTests
    {
        ...
        [Fact]
        public async Task Should_Throw_Exception_When_Updating_Nonexistent_Device()
        {
            // Arrange
            var deviceService = new DeviceService();

            // Act & Assert
            await Assert.ThrowsAsync<DeviceNotFoundException>(() => deviceService.UpdateDeviceData("nonexistent-device", 30.0, 70));
        }
